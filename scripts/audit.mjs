...
['css/phase-23-premium-learning.css', 'js/premium-learning-shell.js', 'scripts/phase23-visual-qa.cjs', 'assets/icons/learn-home.svg', 'assets/icons/learn-course.svg', 'assets/icons/learn-assessment.svg', 'assets/icons/learn-report.svg', 'assets/icons/learn-lab.svg', 'assets/icons/learn-profile.svg', 'assets/icons/learn-calendar.svg', 'assets/icons/learn-lock.svg'].forEach((file) => { if (!fs.existsSync(path.join(root, file))) errors.push(`Arquivo obrigatório ausente: ${file}`); });
['css/phase-25-premium-perception.css', 'js/premium-showcase.js', 'scripts/phase25-visual-qa.cjs', 'BUILD-FASE-25.txt', 'assets/brand/logo-oficial-emp.webp', 'assets/campaign/formas-pagamento.webp', 'assets/curriculum/daws.webp', 'assets/curriculum/plugins-e-mixagem.webp'].forEach((file) => { if (!fs.existsSync(path.join(root, file))) errors.push(`Arquivo obrigatório ausente: ${file}`); });

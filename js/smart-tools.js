document.addEventListener('DOMContentLoaded', () => {
  ...
  const responses = [
    { keys: ['mix', 'equaliza', 'compress'], text: 'Para avançar em mixagem, retome o M13: comece pelo ganho e pela intenção de cada faixa antes de equalizar ou comprimir.' },
    ...
    { keys: ['certificado', 'certifica'], text: 'O certificado é liberado após cumprir os critérios de progresso e avaliação publicados. Ele será emitido pelo Instituto Musical Vale.' },

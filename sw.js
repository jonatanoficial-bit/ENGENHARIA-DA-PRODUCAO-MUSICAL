const CACHE_NAME = 'emp-v1-12-0';
const APP_SHELL = [
  './', './index.html', './css/tokens.css', './css/base.css', './css/components.css',
  './css/layout.css', './css/phase-2.css', './css/phase-3.css', './css/platform.css', './css/final-polish.css', './css/phase-12.css', './css/phase-13.css', './css/phase-14.css', './css/phase-15.css', './css/phase-16.css', './css/phase-17.css', './css/phase-18.css', './css/phase-19.css', './css/phase-20.css', './css/phase-21.css', './css/phase-22.css', './css/phase-23-premium-learning.css', './css/phase-24-portal-experience.css', './css/phase-25-premium-perception.css', './js/app.js', './js/home.js', './js/premium-showcase.js', './js/portal.js', './js/course-catalog.js', './js/premium-learning-shell.js', './js/portal-session-controls.js', './js/student-assessments.js', './js/student-projects.js', './js/student-profile.js', './js/student-report-card.js', './js/student-access-tracker.js', './js/teacher-portal.js', './js/teacher-academic-dashboard.js', './js/academic-model.js', './js/supporters.js', './js/checkout-links.js', './js/smart-tools.js', './components/component-loader.js', './firebase/access-routing.js', './site.webmanifest'
];
